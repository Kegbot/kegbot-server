...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_kegsessionchunk', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='keg_chunks', to=orm['core.KegbotSite']), keep_default=False)

        # Adding field 'UserSessionChunk.site'
        db.add_column('core_usersessionchunk', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_chunks', to=orm['core.KegbotSite']), keep_default=False)

        if not db.dry_run:
            for chunk in orm.KegSessionChunk.objects.all():
                chunk.site = chunk.session.site
                chunk.save()

            for chunk in orm.UserSessionChunk.objects.all():
                chunk.site = chunk.session.site
                chunk.save()
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_kegsessionchunk', 'site_id')

        # Deleting field 'UserSessionChunk.site'
        db.delete_column('core_usersessionchunk', 'site_id')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'2718dae493143e1c8a919501aeaa9080'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
