...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Keg.notified_empty'
        db.add_column(u'core_keg', 'notified_empty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SiteSettings.keg_empty_notification_email_address'
        db.add_column(u'core_sitesettings', 'keg_empty_notification_email_address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Keg.notified_empty'
        db.delete_column(u'core_keg', 'notified_empty')

        # Deleting field 'SiteSettings.keg_empty_notification_email_address'
        db.delete_column(u'core_sitesettings', 'keg_empty_notification_email_address')
    ...
    models = {
        ...
        u'core.keg': {
            ...
            'notified_empty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'core.sitesettings': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg_empty_notification_email_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'web_hook_urls': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'core.systemevent': {
