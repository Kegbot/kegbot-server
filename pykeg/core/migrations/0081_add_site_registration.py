...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrinkingSession.slug'
        db.alter_column('core_drinkingsession', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('site',), null=True, populate_from='name'))
        # Adding field 'SiteSettings.registration_allowed'
        db.add_column('core_sitesettings', 'registration_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SiteSettings.registration_confirmation'
        db.add_column('core_sitesettings', 'registration_confirmation',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DrinkingSession.slug'
        db.alter_column('core_drinkingsession', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from=None, unique_with=(), max_length=50, null=True))
        # Deleting field 'SiteSettings.registration_allowed'
        db.delete_column('core_sitesettings', 'registration_allowed')

        # Deleting field 'SiteSettings.registration_confirmation'
        db.delete_column('core_sitesettings', 'registration_confirmation')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'0d77e39b29aedf54dab0bc2cf645c26a'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
