...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DrinkingSession.slug'
        db.add_column('core_drinkingsession', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, blank=True, null=True, populate_from=None, db_index=True), keep_default=False)

        # Adding field 'DrinkingSession.name'
        db.add_column('core_drinkingsession', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'DrinkingSession.slug'
        db.delete_column('core_drinkingsession', 'slug')

        # Deleting field 'DrinkingSession.name'
        db.delete_column('core_drinkingsession', 'name')
