...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KegSize.volume_ml'
        db.add_column('core_kegsize', 'volume_ml', orm['core.kegsize:volume_ml'])
        
        # Adding field 'Drink.volume_ml'
        db.add_column('core_drink', 'volume_ml', orm['core.drink:volume_ml'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'KegSize.volume_ml'
        db.delete_column('core_kegsize', 'volume_ml')
        
        # Deleting field 'Drink.volume_ml'
        db.delete_column('core_drink', 'volume_ml')
