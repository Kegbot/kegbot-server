...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_kegbotsite', 'hostname',
                      self.gf('django.db.models.fields.CharField')(default='localhost', max_length=255),
                      keep_default=False)
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'dc348d409f29751e159e46acd45d6ee8'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.kegbotsite': {
            ...
            'epoch': ('django.db.models.fields.PositiveIntegerField', [], {'default': '107'}),
