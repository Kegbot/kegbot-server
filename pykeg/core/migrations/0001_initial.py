    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                re.compile(b"^[\\w.@+-]+$"), "Enter a valid username.", b"invalid"
                            )
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default=b"",
                        help_text=b"Full name, will be shown in some places instead of username",
                        max_length=127,
                    ),
                ),
                (
                ...
                (
                    "activation_key",
                    models.CharField(
                        help_text=b"Unguessable token, used to finish registration.",
                        max_length=128,
                        null=True,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "active",
                    models.BooleanField(
                        default=True, help_text=b"Whether access by this key is currently allowed."
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        help_text=b"Information about this key.", null=True, blank=True
                    ),
                ),
                (
                    "created_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text=b"Time the key was created."
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auth_device",
                    models.CharField(help_text=b"Namespace for this token.", max_length=64),
                ),
                (
                    "token_value",
                    models.CharField(
                        help_text=b"Actual value of the token, unique within an auth_device.",
                        max_length=128,
                    ),
                ),
                (
                    "nice_name",
                    models.CharField(
                        help_text=b'A human-readable alias for the token, for example "Guest Key".',
                        max_length=256,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "pin",
                    models.CharField(
                        help_text=b"A secret value necessary to authenticate with this token.",
                        max_length=256,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "enabled",
                    models.BooleanField(
                        default=True, help_text=b"Whether this token is considered active."
                    ),
                ),
                (
                    "created_time",
                    models.DateTimeField(
                        help_text=b"Date token was first added to the system.", auto_now_add=True
                    ),
                ),
                (
                    "expire_time",
                    models.DateTimeField(
                        help_text=b"Date after which token is treated as disabled.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text=b"User in possession of and authenticated by this token.",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text=b'Name of the beverage, such as "Potrero Pale".', max_length=255
                    ),
                ),
                (
                    "beverage_type",
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (b"wine", b"Wine"),
                            (b"soda", b"Soda"),
                            (b"kombucha", b"Kombucha"),
                            (b"other", b"Other/Unknown"),
                        ],
                    ),
                ),
                (
                    "style",
                    models.CharField(
                        help_text=b'Beverage style within type, eg "Pale Ale", "Pinot Noir".',
                        max_length=255,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "description",
                    models.TextField(
                        help_text=b"Free-form description of the beverage.", null=True, blank=True
                    ),
                ),
                (
                    "vintage_year",
                    models.DateField(
                        help_text=b"Date of production, for wines or special/seasonal editions",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    "abv_percent",
                    models.FloatField(
                        help_text=b"Alcohol by volume, as percentage (0.0-100.0).",
                        null=True,
                        verbose_name=b"ABV Percentage",
                        blank=True,
                    ),
                ),
                (
                    "calories_per_ml",
                    models.FloatField(
                        help_text=b"Calories per mL of beverage.", null=True, blank=True
                    ),
                ),
                (
                    "carbs_per_ml",
                    models.FloatField(
                        help_text=b"Carbohydrates per mL of beverage.", null=True, blank=True
                    ),
                ),
                (
                    "color_hex",
                    models.CharField(
                        default=b"#C35900",
                        help_text=b"Approximate beverage color",
                        max_length=16,
                        verbose_name=b"Color (Hex Value)",
                        validators=[
                            django.core.validators.RegexValidator(
                                regex=b"(^#[0-9a-zA-Z]{3}$)|(^#[0-9a-zA-Z]{6}$)",
                                message=b'Color must start with "#" and include 3 or 6 hex characters, like #123 or #123456.',
                                code=b"bad_color",
                            )
                        ],
                    ),
                ...
                (
                    "original_gravity",
                    models.FloatField(
                        help_text=b"Original gravity (beer only).", null=True, blank=True
                    ),
                ),
                (
                    "specific_gravity",
                    models.FloatField(
                        help_text=b"Final gravity (beer only).", null=True, blank=True
                    ),
                ),
                (
                    "srm",
                    models.FloatField(
                        help_text=b"Standard Reference Method value (beer only).",
                        null=True,
                        verbose_name=b"SRM Value",
                        blank=True,
                    ),
                ),
                (
                    "ibu",
                    models.FloatField(
                        help_text=b"International Bittering Units value (beer only).",
                        null=True,
                        verbose_name=b"IBUs",
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.FloatField(
                        blank=True,
                        help_text=b"Star rating for beverage (0: worst, 5: best)",
                        null=True,
                        validators=[
                ...
                (
                    "untappd_beer_id",
                    models.IntegerField(
                        help_text=b"Untappd.com resource ID (beer only).", null=True, blank=True
                    ),
                ),
                (
                    "beverage_backend",
                    models.CharField(
                        help_text=b"Future use.", max_length=255, null=True, blank=True
                    ),
                ),
                (
                    "beverage_backend_id",
            ...
            fields=[
                ...
                (
                    ...
                    pykeg.core.fields.CountryField(
                        ...
                        choices=[
                            ...
                            (b"TCD", "Chad"),
                            (b"CIL", "Channel Islands"),
                            (b"CHL", "Chile"),
                            (b"CHN", "China"),
                            (b"HKG", "China - Hong Kong"),
                            (b"MAC", "China - Macao"),
                            (b"COL", "Colombia"),
                            (b"COM", "Comoros"),
                            (b"COG", "Congo"),
                            ...
                            (b"CUB", "Cuba"),
                            (b"CYP", "Cyprus"),
                            (b"CZE", "Czech Republic"),
                            (b"PRK", "Democratic People's Republic of Korea"),
                            (b"COD", "Democratic Republic of the Congo"),
                            (b"DNK", "Denmark"),
                            (b"DJI", "Djibouti"),
                            (b"DMA", "Dominica"),
                            ...
                            (b"EST", "Estonia"),
                            (b"ETH", "Ethiopia"),
                            (b"FRO", "Faeroe Islands"),
                            (b"FLK", "Falkland Islands (Malvinas)"),
                            (b"FJI", "Fiji"),
                            (b"FIN", "Finland"),
                            (b"FRA", "France"),
                            (b"GUF", "French Guiana"),
                            ...
                            (b"KWT", "Kuwait"),
                            (b"KGZ", "Kyrgyzstan"),
                            (b"LAO", "Lao People's Democratic Republic"),
                            (b"LVA", "Latvia"),
                            (b"LBN", "Lebanon"),
                            (b"LSO", "Lesotho"),
                            (b"LBR", "Liberia"),
                            (b"LBY", "Libyan Arab Jamahiriya"),
                            (b"LIE", "Liechtenstein"),
                            (b"LTU", "Lithuania"),
                            (b"LUX", "Luxembourg"),
                            (b"MKD", "Macedonia"),
                            ...
                            (b"MYT", "Mayotte"),
                            (b"MEX", "Mexico"),
                            (b"FSM", "Micronesia, Federated States of"),
                            (b"MCO", "Monaco"),
                            (b"MNG", "Mongolia"),
                            (b"MNE", "Montenegro"),
                            (b"MSR", "Montserrat"),
                            ...
                            (b"NOR", "Norway"),
                            (b"PSE", "Occupied Palestinian Territory"),
                            (b"OMN", "Oman"),
                            (b"PAK", "Pakistan"),
                            (b"PLW", "Palau"),
                            (b"PAN", "Panama"),
                            ...
                            (b"PRI", "Puerto Rico"),
                            (b"QAT", "Qatar"),
                            (b"KOR", "Republic of Korea"),
                            (b"MDA", "Republic of Moldova"),
                            (b"REU", "Reunion"),
                            (b"ROU", "Romania"),
                            (b"RUS", "Russian Federation"),
                            (b"RWA", "Rwanda"),
                            (b"BLM", "Saint-Barthelemy"),
                            (b"SHN", "Saint Helena"),
                            (b"KNA", "Saint Kitts and Nevis"),
                            (b"LCA", "Saint Lucia"),
                            (b"MAF", "Saint-Martin (French part)"),
                            (b"SPM", "Saint Pierre and Miquelon"),
                            (b"VCT", "Saint Vincent and the Grenadines"),
                            (b"WSM", "Samoa"),
                            (b"SMR", "San Marino"),
                            (b"STP", "Sao Tome and Principe"),
                            (b"SAU", "Saudi Arabia"),
                            (b"SEN", "Senegal"),
                            (b"SRB", "Serbia"),
                            (b"SYC", "Seychelles"),
                            ...
                            (b"SDN", "Sudan"),
                            (b"SUR", "Suriname"),
                            (b"SJM", "Svalbard and Jan Mayen Islands"),
                            (b"SWZ", "Swaziland"),
                            (b"SWE", "Sweden"),
                            (b"CHE", "Switzerland"),
                            (b"SYR", "Syrian Arab Republic"),
                            (b"TJK", "Tajikistan"),
                            (b"THA", "Thailand"),
                            (b"TLS", "Timor-Leste"),
                            (b"TGO", "Togo"),
                            ...
                            (b"TZA", "United Republic of Tanzania"),
                            (b"USA", "United States of America"),
                            (b"VIR", "United States Virgin Islands"),
                            (b"URY", "Uruguay"),
                            (b"UZB", "Uzbekistan"),
                            (b"VUT", "Vanuatu"),
                            (b"VEN", "Venezuela (Bolivarian Republic of)"),
                            (b"VNM", "Viet Nam"),
                            (b"WLF", "Wallis and Futuna Islands"),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=128,
                        null=True,
                        help_text=b"State of origin, if applicable",
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=128,
                        null=True,
                        help_text=b"City of origin, if known",
                        blank=True,
                    ),
                ),
                ...
                (
                    "url",
                    models.URLField(
                        default=b"", null=True, help_text=b"Brewer's home page", blank=True
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        default=b"",
                        help_text=b"A short description of the brewer",
                        null=True,
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text=b"Identifying name for this device; must be unique.",
                        unique=True,
                        max_length=128,
                    ),
                ),
                (
                    "model_name",
                    models.CharField(
                        help_text=b"Type of controller (optional).",
                        max_length=128,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "serial_number",
                    models.CharField(
                        help_text=b"Serial number (optional).",
                        max_length=128,
                        null=True,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text=b"Time the device was created."
                    ),
                ),
            ],
            options={},
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        help_text=b"Flow sensor ticks, never changed once recorded.", editable=False
                    ),
                ),
                (
                    "volume_ml",
                    models.FloatField(
                        help_text=b"Calculated (or set) Drink volume.", editable=False
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text=b"Time in seconds taken to pour this Drink.",
                        editable=False,
                        blank=True,
                    ),
                ),
                (
                    "shout",
                    models.TextField(
                        help_text=b"Comment from the drinker at the time of the pour.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    "tick_time_series",
                    models.TextField(
                        help_text=b"Tick update sequence that generated this drink (diagnostic data).",
                        null=True,
                        editable=False,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "port_name",
                    models.CharField(
                        help_text=b"Controller-specific data port name for this meter.",
                        max_length=128,
                    ),
                ),
                (
                    ...
                    models.FloatField(
                        default=2.724,
                        help_text=b"Flow meter pulses per mL of fluid.  Common values: 2.724 (FT330-RJ), 5.4 (SF800)",
                    ),
                ),
                (
                    "controller",
                    models.ForeignKey(
                        ...
                        related_name="meters",
                        to="core.Controller",
                        help_text=b"Controller that owns this meter.",
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "port_name",
                    models.CharField(
                        help_text=b"Controller-specific data port name for this toggle.",
                        max_length=128,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="core.Controller",
                        help_text=b"Controller that owns this toggle.",
                    ),
                ),
            ],
            options={},
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text=b"Unguessable token which must be presented to use this invite",
                        unique=True,
                        max_length=255,
                    ),
                ),
                (
                    "for_email",
                    models.EmailField(
                        help_text=b"Address this invitation was sent to.", max_length=75
                    ),
                ),
                (
                    "invited_date",
                    models.DateTimeField(
                        help_text=b"Date and time the invitation was sent",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text=b"Date and time after which the invitation is considered expired",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        help_text=b"User that created this invitation, if any.",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "keg_type",
                    models.CharField(
                        default=b"half-barrel",
                        help_text=b"Keg container type, used to initialize keg's full volume",
                        max_length=32,
                        choices=[
                            (b"quarter", b"Quarter Barrel (7.75 gal)"),
                            (b"corny", b"Corny Keg (5 gal)"),
                            (b"sixth", b"Sixth Barrel (5.17 gal)"),
                            (b"other", b"Other"),
                            (b"euro-half", b"European Half Barrel (50 L)"),
                            (b"half-barrel", b"Half Barrel (15.5 gal)"),
                            (b"euro", b"European Full Barrel (100 L)"),
                        ],
                    ),
                ),
                (
                    "served_volume_ml",
                    models.FloatField(
                        default=0, help_text=b"Computed served volume.", editable=False
                    ),
                ),
                (
                    "full_volume_ml",
                    models.FloatField(
                        default=0,
                        help_text=b"Full volume of this Keg; usually set automatically from keg_type.",
                        editable=False,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text=b"Time the Keg was first tapped.",
                    ),
                ),
                (
                    "end_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now,
                        help_text=b"Time the Keg was finished or disconnected.",
                    ),
                ),
                (
                    "online",
                    models.BooleanField(
                        default=True,
                        help_text=b"True if the keg is currently assigned to a tap.",
                        editable=False,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"True when the Keg has been exhausted or discarded.",
                        editable=False,
                    ),
                ),
                (
                    "description",
                    models.CharField(
                        help_text=b"User-visible description of the Keg.",
                        max_length=256,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.FloatField(
                        default=0,
                        help_text=b"Amount of beverage poured without an associated Drink.",
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        help_text=b"Private notes about this keg, viewable only by admins.",
                        null=True,
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="core.Beverage",
                        help_text=b"Beverage in this Keg.",
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default=b"default", unique=True, max_length=64, editable=False
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"True if the site has completed setup.",
                        editable=False,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        default=b"",
                        help_text=b"A unique id for this system.",
                        max_length=128,
                        editable=False,
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        default=b"imperial",
                        help_text=b"Unit system to use when displaying volumetric data.",
                        max_length=64,
                        choices=[
                            (b"metric", b"Metric (mL, L)"),
                            (b"imperial", b"Imperial (oz, pint)"),
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default=b"f",
                        help_text=b"Unit system to use when displaying temperature data.",
                        max_length=64,
                        choices=[(b"f", b"Fahrenheit"), (b"c", b"Celsius")],
                    ),
                ),
                (
                    "title",
                    models.CharField(
                        default=b"My Kegbot", help_text=b"The title of this site.", max_length=64
                    ),
                ),
                (
                    "google_analytics_id",
                    models.CharField(
                        help_text=b"Set to your Google Analytics ID to enable tracking. Example: UA-XXXX-y",
                        max_length=64,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=180,
                        help_text=b"Maximum time, in minutes, that a session may be idle (no pours) before it is considered to be finished.  Recommended value is 180.",
                    ),
                ),
                (
                    "privacy",
                    models.CharField(
                        default=b"public",
                        help_text=b"Who can view Kegbot data?",
                        max_length=63,
                        choices=[
                            (b"public", b"Public: Browsing does not require login"),
                            (b"members", b"Members only: Must log in to browse"),
                            (b"staff", b"Staff only: Only logged-in staff accounts may browse"),
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default=b"public",
                        help_text=b"Who can join this Kegbot from the web site?",
                        max_length=63,
                        choices=[
                            (b"public", b"Public: Anyone can register."),
                            (
                                b"member-invite-only",
                                b"Member Invite: Must be invited by an existing member.",
                            ),
                            (
                                b"staff-invite-only",
                                b"Staff Invite Only: Must be invited by a staff member.",
                            ),
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default=b"UTC",
                        help_text=b"Time zone for this system.",
                        max_length=255,
                        choices=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text=b'Periodically check for updates (<a href="https://kegbot.org/about/checkin">more info</a>)',
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text=b'The display name for this tap, for example, "Main Tap".',
                        max_length=128,
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        help_text=b"User-visible description for this tap.", null=True, blank=True
                    ),
                ),
                (
                    "sort_order",
                    models.PositiveIntegerField(
                        default=0,
                        help_text=b"Position relative to other taps when sorting (0=first).",
                    ),
                ),
                (
                    "current_keg",
                    models.OneToOneField(
                        ...
                        blank=True,
                        to="core.Keg",
                        help_text=b"Keg currently connected to this tap.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "backend",
                    models.CharField(
                        help_text=b"Notification backend (dotted path) for these settings.",
                        max_length=255,
                    ),
                ),
                (
                    "keg_tapped",
                    models.BooleanField(default=True, help_text=b"Sent when a keg is activated."),
                ),
                (
                    "session_started",
                    models.BooleanField(
                        default=False, help_text=b"Sent when a new drinking session starts."
                    ),
                ),
                (
                    "keg_volume_low",
                    models.BooleanField(default=False, help_text=b"Sent when a keg becomes low."),
                ),
                (
                    "keg_ended",
                    models.BooleanField(
                        default=False, help_text=b"Sent when a keg has been taken offline."
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        help_text=b"User for these settings.",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        help_text=b"The image", upload_to=pykeg.core.models._pics_file_name
                    ),
                ),
                (
                    "time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text=b"Time/date of image capture"
                    ),
                ),
                (
                    "caption",
                    models.TextField(
                        help_text=b"Caption for the picture, if any.", null=True, blank=True
                    ),
                ),
                (
                    "keg",
                    models.ForeignKey(
                        ...
                        blank=True,
                        to="core.Keg",
                        help_text=b"Keg this picture was taken with, if any.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text=b"Session this picture was taken with, if any.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to=settings.AUTH_USER_MODEL,
                        help_text=b"User that owns/uploaded this picture",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"True if this is the most first record for the view.",
                    ),
                ),
                (
                    "drink",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        help_text=b"Type of event.",
                        max_length=255,
                        choices=[
                            (b"drink_poured", b"Drink poured"),
                            (b"session_started", b"Session started"),
                            (b"session_joined", b"User joined session"),
                            (b"keg_tapped", b"Keg tapped"),
                            (b"keg_volume_low", b"Keg volume low"),
                            (b"keg_ended", b"Keg ended"),
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to="core.Drink",
                        help_text=b"Drink involved in the event, if any.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to="core.Keg",
                        help_text=b"Keg involved in the event, if any.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to="core.DrinkingSession",
                        help_text=b"Session involved in the event, if any.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to=settings.AUTH_USER_MODEL,
                        help_text=b"User responsible for the event, if any.",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text=b"Optional sensor monitoring the temperature at this tap.",
                null=True,
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                blank=True,
                to="core.Picture",
                help_text=b"Background for this site.",
                null=True,
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                blank=True,
                to="core.KegTap",
                help_text=b"Tap to which this toggle is currently bound.",
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                blank=True,
                to="core.KegTap",
                help_text=b"Tap to which this meter is currently bound.",
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                editable=False,
                to="core.Keg",
                help_text=b"Keg against which this Drink is accounted.",
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                blank=True,
                to="core.Picture",
                help_text=b"Picture snapped with this drink.",
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                editable=False,
                to="core.DrinkingSession",
                help_text=b"Session where this Drink is grouped.",
                null=True,
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                editable=False,
                to=settings.AUTH_USER_MODEL,
                help_text=b"User responsible for this Drink, or None if anonymous/unknown.",
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.SET_NULL,
                to="core.Device",
                help_text=b"Device this key is associated with.",
                null=True,
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                blank=True,
                to=settings.AUTH_USER_MODEL,
                help_text=b"User receiving API access.",
                null=True,
            ),
            preserve_default=True,
        ),
