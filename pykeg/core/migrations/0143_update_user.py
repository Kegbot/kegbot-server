...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_user', 'last_name')

        # Deleting field 'User.first_name'
        db.delete_column(u'core_user', 'first_name')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_user', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'User.first_name'
        db.add_column(u'core_user', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'1188fc2280aa3fdacf2c4cb9d6ea1093'", 'unique': 'True', 'max_length': '127'}),
