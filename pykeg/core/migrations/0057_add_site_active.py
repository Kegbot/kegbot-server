...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KegbotSite.is_active'
        db.add_column('core_kegbotsite', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KegbotSite.is_active'
        db.delete_column('core_kegbotsite', 'is_active')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'c0630599b2dbbbec2eebe9264d009bf8'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
