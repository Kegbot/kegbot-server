...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteSettings.title'
        db.alter_column(u'core_sitesettings', 'title', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'SiteSettings.title'
        db.alter_column(u'core_sitesettings', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
