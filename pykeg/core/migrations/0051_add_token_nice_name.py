...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthenticationToken.nice_name'
        db.add_column('core_authenticationtoken', 'nice_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthenticationToken.nice_name'
        db.delete_column('core_authenticationtoken', 'nice_name')
    ...
    models = {
        ...
        'core.keg': {
            ...
            'spilled_ml': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
