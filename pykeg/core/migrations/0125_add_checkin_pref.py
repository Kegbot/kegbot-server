...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.check_for_updates'
        db.add_column(u'core_sitesettings', 'check_for_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.check_for_updates'
        db.delete_column(u'core_sitesettings', 'check_for_updates')
