...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'core_kegsize')

        # Deleting field 'Keg.size'
        db.delete_column(u'core_keg', 'size_id')


    def backwards(self, orm):
        # Adding model 'KegSize'
        db.create_table(u'core_kegsize', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volume_ml', self.gf('django.db.models.fields.FloatField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'core', ['KegSize'])


        # User chose to not deal with backwards NULL issues for 'Keg.size'
        raise RuntimeError("Cannot reverse this migration. 'Keg.size' and its values cannot be restored.")
