...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_drink', 'session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DrinkingSession'], null=True, blank=True), keep_default=False)
        for sess in orm.DrinkingSession.objects.all():
          for d in sess.drinks.all():
            d.session = sess
            d.save()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Drink.session'
        db.delete_column('core_drink', 'session_id')
