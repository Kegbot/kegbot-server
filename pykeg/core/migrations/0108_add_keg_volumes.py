...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Keg.served_volume_ml'
        db.add_column(u'core_keg', 'served_volume_ml',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Keg.full_volume_ml'
        db.add_column(u'core_keg', 'full_volume_ml',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Keg.served_volume_ml'
        db.delete_column(u'core_keg', 'served_volume_ml')

        # Deleting field 'Keg.full_volume_ml'
        db.delete_column(u'core_keg', 'full_volume_ml')
