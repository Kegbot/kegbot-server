...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KegTap.current_keg'
        db.alter_column('core_kegtap', 'current_keg_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Keg']))

        # Adding unique constraint on 'KegTap', fields ['current_keg']
        db.create_unique('core_kegtap', ['current_keg_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'KegTap', fields ['current_keg']
        db.delete_unique('core_kegtap', ['current_keg_id'])

        # Changing field 'KegTap.current_keg'
        db.alter_column('core_kegtap', 'current_keg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Keg'], null=True))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'e40f68ac3f9feef63d0cc4b109b6cf8c'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
