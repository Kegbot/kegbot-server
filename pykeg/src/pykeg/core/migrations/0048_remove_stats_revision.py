...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'KegStats.revision'
        db.delete_column('core_kegstats', 'revision')

        # Deleting field 'UserStats.revision'
        db.delete_column('core_userstats', 'revision')

        # Deleting field 'SessionStats.revision'
        db.delete_column('core_sessionstats', 'revision')

        # Deleting field 'SystemStats.revision'
        db.delete_column('core_systemstats', 'revision')
    
    
    def backwards(self, orm):
        
        # Adding field 'KegStats.revision'
        db.add_column('core_kegstats', 'revision', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'UserStats.revision'
        db.add_column('core_userstats', 'revision', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'SessionStats.revision'
        db.add_column('core_sessionstats', 'revision', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'SystemStats.revision'
        db.add_column('core_systemstats', 'revision', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
