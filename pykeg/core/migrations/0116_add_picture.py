...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picture.caption'
        db.add_column(u'core_picture', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picture.user'
        db.add_column(u'core_picture', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_pictures', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Picture.keg'
        db.add_column(u'core_picture', 'keg',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_pictures', null=True, on_delete=models.SET_NULL, to=orm['core.Keg']),
                      keep_default=False)

        # Adding field 'Picture.session'
        db.add_column(u'core_picture', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_pictures', null=True, on_delete=models.SET_NULL, to=orm['core.DrinkingSession']),
                      keep_default=False)

        # Adding field 'Drink.picture'
        db.add_column(u'core_drink', 'picture',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Picture'], unique=True, null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        if not db.dry_run:
            for pp in orm['core.PourPicture'].objects.all():
                base_pic = pp.picture

                base_pic.caption = pp.caption
                base_pic.user = pp.user
                base_pic.session = pp.session
                base_pic.keg = pp.keg
                base_pic.save()

                if pp.drink:
                    pp.drink.picture = base_pic
                    pp.drink.save()


    def backwards(self, orm):
        # Deleting field 'Picture.caption'
        db.delete_column(u'core_picture', 'caption')

        # Deleting field 'Picture.user'
        db.delete_column(u'core_picture', 'user_id')

        # Deleting field 'Picture.keg'
        db.delete_column(u'core_picture', 'keg_id')

        # Deleting field 'Picture.session'
        db.delete_column(u'core_picture', 'session_id')

        # Deleting field 'Drink.picture'
        db.delete_column(u'core_drink', 'picture_id')
    ...
    models = {
        ...
        u'core.picture': {
            ...
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_pictures'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['core.Keg']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_pictures'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['core.DrinkingSession']"}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_pictures'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'core.pourpicture': {
            'Meta': {'ordering': "('-time',)", 'object_name': 'PourPicture'},
            'caption': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
