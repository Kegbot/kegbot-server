...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiKey.device'
        db.add_column(u'core_apikey', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Device'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ApiKey.device'
        db.delete_column(u'core_apikey', 'device_id')
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'a04bc4b023dace34e53ec3ffee818c1d'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.kegbotsite': {
            ...
            'epoch': ('django.db.models.fields.PositiveIntegerField', [], {'default': '106'}),
