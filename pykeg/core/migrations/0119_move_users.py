...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_apikey', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.User'], unique=True))

        # Changing field 'SystemEvent.user'
        db.alter_column(u'core_systemevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'UserStats.user'
        db.alter_column(u'core_userstats', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'Picture.user'
        db.alter_column(u'core_picture', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'Drink.user'
        db.alter_column(u'core_drink', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'AuthenticationToken.user'
        db.alter_column(u'core_authenticationtoken', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'SiteSettings.default_user'
        db.alter_column(u'core_sitesettings', 'default_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True))

        # Changing field 'SessionChunk.user'
        db.alter_column(u'core_sessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'UserSessionChunk.user'
        db.alter_column(u'core_usersessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

    def backwards(self, orm):

        # Changing field 'ApiKey.user'
        db.alter_column(u'core_apikey', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'SystemEvent.user'
        db.alter_column(u'core_systemevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'UserStats.user'
        db.alter_column(u'core_userstats', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Picture.user'
        db.alter_column(u'core_picture', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Drink.user'
        db.alter_column(u'core_drink', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AuthenticationToken.user'
        db.alter_column(u'core_authenticationtoken', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'SiteSettings.default_user'
        db.alter_column(u'core_sitesettings', 'default_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'SessionChunk.user'
        db.alter_column(u'core_sessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'UserSessionChunk.user'
        db.alter_column(u'core_usersessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
