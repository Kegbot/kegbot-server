...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_drinkingsession', (
            ('id', orm['core.drinkingsession:id']),
            ('starttime', orm['core.drinkingsession:starttime']),
            ('endtime', orm['core.drinkingsession:endtime']),
        ))
        db.send_create_signal('core', ['DrinkingSession'])
        
        # Adding ManyToManyField 'DrinkingSession.kegs'
        db.create_table('core_drinkingsession_kegs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('drinkingsession', models.ForeignKey(orm.DrinkingSession, null=False)),
            ('keg', models.ForeignKey(orm.Keg, null=False))
        ))
        
        # Adding ManyToManyField 'DrinkingSession.drinks'
        db.create_table('core_drinkingsession_drinks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('drinkingsession', models.ForeignKey(orm.DrinkingSession, null=False)),
            ('drink', models.ForeignKey(orm.Drink, null=False))
        ))
        
        # Adding ManyToManyField 'DrinkingSession.users'
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'DrinkingSession.kegs'
        db.delete_table('core_drinkingsession_kegs')
        
        # Dropping ManyToManyField 'DrinkingSession.drinks'
        db.delete_table('core_drinkingsession_drinks')
        
        # Dropping ManyToManyField 'DrinkingSession.users'
        ...
        db.create_table('core_userdrinkingsession', (
            ('group', orm['core.drinkingsession:group']),
            ('user', orm['core.drinkingsession:user']),
            ('starttime', orm['core.drinkingsession:starttime']),
            ('endtime', orm['core.drinkingsession:endtime']),
            ('id', orm['core.drinkingsession:id']),
        ))
        ...
        db.create_table('core_userdrinkingsessionassignment', (
            ('session', orm['core.drinkingsession:session']),
            ('drink', orm['core.drinkingsession:drink']),
            ('id', orm['core.drinkingsession:id']),
        ))
