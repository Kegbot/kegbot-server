...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for tap in orm['core.KegTap'].objects.all():
            meter_name = tap.meter_name
            idx = meter_name.find('.')
            if idx <= 0:
                raise ValueError('Unexpected meter name: %s' % meter_name)
    ...
    def backwards(self, orm):
        orm['core.Controller'].objects.all().delete()
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ccc8691056ad2015a03d34f99b481486'", 'unique': 'True', 'max_length': '127'}),
