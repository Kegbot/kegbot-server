...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
      for site in orm['core.KegbotSite'].objects.filter(name='default'):
        if site.guest_image:
          for guest in orm['core.User'].objects.filter(username='guest'):
            guest.mugshot = site.guest_image
            guest.save()
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'5b284951c90c8e3d8f6f0b8551d13e60'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'91842997-380f-492e-a569-7463e1ee2af8'", 'unique': 'True', 'max_length': '255'}),
