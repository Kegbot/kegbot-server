...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiKey.created_time'
        db.add_column(u'core_apikey', 'created_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'ApiKey.user'
        db.alter_column(u'core_apikey', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'ApiKey.description'
        db.delete_column(u'core_apikey', 'description')

        # Deleting field 'ApiKey.created_time'
        db.delete_column(u'core_apikey', 'created_time')
        ...
        # Adding unique constraint on 'ApiKey', fields ['user']
        db.create_unique(u'core_apikey', ['user_id'])
