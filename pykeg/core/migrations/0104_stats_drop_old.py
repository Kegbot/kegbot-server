...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'KegStats.keg'
        raise RuntimeError("Cannot reverse this migration. 'KegStats.keg' and its values cannot be restored.")
        # Adding field 'UserStats.user'
        db.add_column(u'core_userstats', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', unique=True, null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'SessionStats.session'
        raise RuntimeError("Cannot reverse this migration. 'SessionStats.session' and its values cannot be restored.")
