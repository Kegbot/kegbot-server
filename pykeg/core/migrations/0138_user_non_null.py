...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_userstats', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User']))

        # Changing field 'Drink.user'
        db.alter_column(u'core_drink', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User']))

        # Changing field 'SessionChunk.keg'
        db.alter_column(u'core_sessionchunk', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Keg']))

        # Changing field 'SessionChunk.user'
        db.alter_column(u'core_sessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User']))

        # Changing field 'UserSessionChunk.user'
        db.alter_column(u'core_usersessionchunk', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.User']))

        # Changing field 'KegSessionChunk.keg'
        db.alter_column(u'core_kegsessionchunk', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Keg']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SessionChunk.keg'
        db.alter_column(u'core_sessionchunk', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Keg'], on_delete=models.PROTECT))
        ...
        # Changing field 'KegSessionChunk.keg'
        db.alter_column(u'core_kegsessionchunk', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Keg']))
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'18a50a06e3f3d72012f20fb5d0d7dbb6'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.kegsessionchunk': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keg_session_chunks'", 'to': u"orm['core.Keg']"}),
        ...
        u'core.sessionchunk': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session_chunks'", 'to': u"orm['core.Keg']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chunks'", 'to': u"orm['core.DrinkingSession']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session_chunks'", 'to': u"orm['core.User']"}),
            'volume_ml': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        u'core.sessionstats': {
        ...
        u'core.usersessionchunk': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_session_chunks'", 'to': u"orm['core.User']"}),
            'volume_ml': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        u'core.userstats': {
            ...
            'stats': ('pykeg.core.jsonfield.JSONField', [], {}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stats'", 'to': u"orm['core.User']"})
        }
    }
