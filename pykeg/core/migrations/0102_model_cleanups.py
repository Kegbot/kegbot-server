...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Keg.finished'
        db.add_column(u'core_keg', 'finished',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'KegTap.max_tick_delta'
        db.delete_column(u'core_kegtap', 'max_tick_delta')

        # Adding unique constraint on 'KegTap', fields ['meter_name']
        db.create_unique(u'core_kegtap', ['meter_name'])

        # Deleting field 'Drink.status'
        db.delete_column(u'core_drink', 'status')


    def backwards(self, orm):
        # Removing unique constraint on 'KegTap', fields ['meter_name']
        db.delete_unique(u'core_kegtap', ['meter_name'])

        # Deleting field 'Keg.finished'
        db.delete_column(u'core_keg', 'finished')

        # Adding field 'KegTap.max_tick_delta'
        db.add_column(u'core_kegtap', 'max_tick_delta',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)

        # Adding field 'Drink.status'
        db.add_column(u'core_drink', 'status',
                      self.gf('django.db.models.fields.CharField')(default='valid', max_length=128),
                      keep_default=False)
