...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_sitesettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='settings', unique=True, to=orm['core.KegbotSite'])),
            ('display_units', self.gf('django.db.models.fields.CharField')(default='imperial', max_length=64)),
        ))
        db.send_create_signal('core', ['SiteSettings'])


    def backwards(self, orm):
        
        # Deleting model 'SiteSettings'
        db.delete_table('core_sitesettings')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'c1ab4a0dad742a1448e4acd6f708651b'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
