...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KegbotSite.server_version'
        db.add_column(u'core_kegbotsite', 'server_version',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KegbotSite.server_version'
        db.delete_column(u'core_kegbotsite', 'server_version')
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'509073f86a7629e652fbbd7552efec97'", 'unique': 'True', 'max_length': '127'}),
