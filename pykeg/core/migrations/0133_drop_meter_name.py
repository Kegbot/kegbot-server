...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KegTap.meter_name'
        db.delete_column(u'core_kegtap', 'meter_name')


    def backwards(self, orm):
        # Adding field 'KegTap.meter_name'
        db.add_column(u'core_kegtap', 'meter_name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=128, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'818f4238a5337031e4d665b0c579a661'", 'unique': 'True', 'max_length': '127'}),
