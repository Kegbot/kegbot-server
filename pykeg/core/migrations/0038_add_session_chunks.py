...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_sessionchunk', (
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='session_chunks', null=True, to=orm['core.Keg'])),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='session_chunks', null=True, to=orm['auth.User'])),
            ('starttime', self.gf('django.db.models.fields.DateTimeField')()),
            ('endtime', self.gf('django.db.models.fields.DateTimeField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('core', ['SessionChunk'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_sessionchunk')
