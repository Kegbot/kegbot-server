...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.guest_name'
        db.add_column('core_sitesettings', 'guest_name',
                      self.gf('django.db.models.fields.CharField')(default='guest', max_length=63),
                      keep_default=False)

        # Adding field 'SiteSettings.guest_image'
        db.add_column('core_sitesettings', 'guest_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='guest_images', null=True, to=orm['core.Picture']),
                      keep_default=False)

        # Adding field 'SiteSettings.default_user'
        db.add_column('core_sitesettings', 'default_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'SiteSettings.privacy'
        db.alter_column('core_sitesettings', 'privacy', self.gf('django.db.models.fields.CharField')(max_length=63))

    def backwards(self, orm):
        # Deleting field 'SiteSettings.guest_name'
        db.delete_column('core_sitesettings', 'guest_name')

        # Deleting field 'SiteSettings.guest_image'
        db.delete_column('core_sitesettings', 'guest_image_id')

        # Deleting field 'SiteSettings.default_user'
        db.delete_column('core_sitesettings', 'default_user_id')
    ...
    models = {
        ...
        'core.sitesettings': {
            ...
            'default_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'guest_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'guest_images'", 'null': 'True', 'to': "orm['core.Picture']"}),
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'6b887f75e8e17952a26e94c70ba7111d'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
