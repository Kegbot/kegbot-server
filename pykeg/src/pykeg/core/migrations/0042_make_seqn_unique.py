...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('core_authenticationtoken', ['auth_device', 'token_value'])
        ...
        db.create_unique('core_drinkingsession', ['site_id', 'seqn'])

        # Adding unique constraint on 'ThermoSensor', fields ['site', 'seqn']
        db.create_unique('core_thermosensor', ['site_id', 'seqn'])

        # Adding unique constraint on 'ThermoSummaryLog', fields ['site', 'seqn']
        db.create_unique('core_thermosummarylog', ['site_id', 'seqn'])

        # Adding unique constraint on 'Keg', fields ['site', 'seqn']
        db.create_unique('core_keg', ['site_id', 'seqn'])

        # Adding unique constraint on 'Drink', fields ['site', 'seqn']
        db.create_unique('core_drink', ['site_id', 'seqn'])

        # Adding unique constraint on 'Thermolog', fields ['site', 'seqn']
        db.create_unique('core_thermolog', ['site_id', 'seqn'])
