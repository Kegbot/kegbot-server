...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KegTap.temperature_sensor'
        db.add_column('core_kegtap', 'temperature_sensor', orm['core.kegtap:temperature_sensor'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'KegTap.temperature_sensor'
        db.delete_column('core_kegtap', 'temperature_sensor_id')
