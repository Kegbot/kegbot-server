...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SessionStats', fields ['drink', 'session']
        db.delete_unique(u'core_sessionstats', ['drink_id', 'session_id'])

        # Removing unique constraint on 'UserStats', fields ['drink', 'user']
        db.delete_unique(u'core_userstats', ['drink_id', 'user_id'])

        # Removing unique constraint on 'KegStats', fields ['drink', 'keg']
        db.delete_unique(u'core_kegstats', ['drink_id', 'keg_id'])

        # Deleting model 'KegStats'
        db.delete_table(u'core_kegstats')

        # Deleting model 'UserStats'
        db.delete_table(u'core_userstats')

        # Deleting model 'SessionStats'
        db.delete_table(u'core_sessionstats')

        # Deleting model 'SystemStats'
        db.delete_table(u'core_systemstats')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'KegStats'
        db.create_table(u'core_kegstats', (
            ('stats', self.gf('pykeg.core.jsonfield.JSONField')()),
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', to=orm['core.Keg'])),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Drink'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['KegStats'])

        # Adding unique constraint on 'KegStats', fields ['drink', 'keg']
        db.create_unique(u'core_kegstats', ['drink_id', 'keg_id'])

        # Adding model 'UserStats'
        db.create_table(u'core_userstats', (
            ('stats', self.gf('pykeg.core.jsonfield.JSONField')()),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Drink'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', to=orm['core.User'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['UserStats'])
        ...
        db.create_table(u'core_sessionstats', (
            ('stats', self.gf('pykeg.core.jsonfield.JSONField')()),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Drink'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stats', to=orm['core.DrinkingSession'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['SessionStats'])

        # Adding unique constraint on 'SessionStats', fields ['drink', 'session']
        db.create_unique(u'core_sessionstats', ['drink_id', 'session_id'])

        # Adding model 'SystemStats'
        db.create_table(u'core_systemstats', (
            ('stats', self.gf('pykeg.core.jsonfield.JSONField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Drink'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'core', ['SystemStats'])
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'af30588d640d7d307ee03cdadf0906b5'", 'unique': 'True', 'max_length': '127'}),
