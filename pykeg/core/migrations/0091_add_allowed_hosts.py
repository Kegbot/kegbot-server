...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.allowed_hosts'
        db.add_column(u'core_sitesettings', 'allowed_hosts',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.allowed_hosts'
        db.delete_column(u'core_sitesettings', 'allowed_hosts')
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'40045060b6939f9ffa3e365292e4d1f0'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
