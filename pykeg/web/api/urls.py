...
urlpatterns = patterns('pykeg.web.api.views',
    ...
    url(r'^taps/?$', 'all_taps'),
    url(r'^taps/(?P<meter_name>[\w\.-]+)/activate/?$', 'tap_activate'),
    url(r'^taps/(?P<meter_name>[\w\.-]+)/spill/?$', 'tap_spill'),
    url(r'^taps/(?P<meter_name>[\w\.-]+)/calibrate/?$', 'tap_calibrate'),
    url(r'^taps/(?P<meter_name>[\w\.-]+)/?$', 'tap_detail'),
