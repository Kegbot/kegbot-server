...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drink.auth_token'
        db.add_column('core_drink', 'auth_token', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Drink.auth_token'
        db.delete_column('core_drink', 'auth_token')
