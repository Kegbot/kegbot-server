...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_flowmeter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('controller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Controller'])),
            ('port_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('tap', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.KegTap'], unique=True, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'e7996af8129eda131ac709513cbd9e98'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.flowmeter': {
            ...
            'controller': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Controller']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'port_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'tap': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.KegTap']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'core.keg': {
