...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_keg', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beerdb.BeerType']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Keg.type'
        db.alter_column('core_keg', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beerdb.BeerType'], null=True, blank=True))
