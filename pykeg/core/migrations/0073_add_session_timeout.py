...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSettings.session_timeout_minutes'
        db.add_column('core_sitesettings', 'session_timeout_minutes', self.gf('django.db.models.fields.PositiveIntegerField')(default=90), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSettings.session_timeout_minutes'
        db.delete_column('core_sitesettings', 'session_timeout_minutes')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'e3d61596e177456978f606535b1e5bc3'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
