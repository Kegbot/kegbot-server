...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Prior to 28c1ed9d, Keg.finished may have been set incorrectly.
        # Walk through all kegs and fix it.
        for keg in orm['core.Keg'].objects.all():
            keg.finished = not keg.online
            keg.save()
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'4b80ef9566a83245aca88cc3123116ff'", 'unique': 'True', 'max_length': '127'}),
