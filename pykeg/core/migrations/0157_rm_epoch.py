...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_kegbotsite', 'epoch')


    def backwards(self, orm):
        # Adding field 'KegbotSite.epoch'
        db.add_column(u'core_kegbotsite', 'epoch',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=108),
                      keep_default=False)
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'73cc4cdc03bfdef1add64bc1df9f4d96'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'c1e57fce-1270-40fb-ba38-161fe5a8c57d'", 'unique': 'True', 'max_length': '255'}),
