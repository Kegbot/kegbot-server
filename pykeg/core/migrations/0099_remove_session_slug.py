...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_drinkingsession', 'slug')


    def backwards(self, orm):
        # Adding field 'DrinkingSession.slug'
        db.add_column(u'core_drinkingsession', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(populate_from='name', unique_with=('site',), max_length=50, null=True, blank=True),
                      keep_default=False)
