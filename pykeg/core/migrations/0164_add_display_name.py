...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.display_name'
        db.add_column(u'core_user', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)
        if not db.dry_run:
    ...
    def backwards(self, orm):
        # Deleting field 'User.display_name'
        db.delete_column(u'core_user', 'display_name')
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'975f2a24359df982b4f97931dff1193c'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'523e21f1-4856-4fed-bed1-9438f75168bb'", 'unique': 'True', 'max_length': '255'}),
