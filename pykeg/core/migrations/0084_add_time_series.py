...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Drink.tick_time_series'
        db.add_column('core_drink', 'tick_time_series',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Drink.tick_time_series'
        db.delete_column('core_drink', 'tick_time_series')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'cdd703c0fb0a4af3ca694e2007c586f6'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
