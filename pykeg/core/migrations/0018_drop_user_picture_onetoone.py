...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserPicture.user'
        db.delete_column('core_userpicture', 'user_id')
        
        # Changing field 'UserPicture.for_user'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['auth.User']))
        db.alter_column('core_userpicture', 'for_user_id', orm['core.userpicture:for_user'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'UserPicture.user'
        db.add_column('core_userpicture', 'user', orm['core.userpicture:user'])
        
        # Changing field 'UserPicture.for_user'
        # (to signature: django.db.models.fields.related.ForeignKey(null=True, to=orm['auth.User'], blank=True))
        db.alter_column('core_userpicture', 'for_user_id', orm['core.userpicture:for_user'])
    ...
    models = {
        ...
        'core.userpicture': {
            ...
            'for_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
