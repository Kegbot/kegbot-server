...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_user', 'activation_key',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_user', 'activation_key')
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'1dd63672a62887701cceda403a242e19'", 'unique': 'True', 'max_length': '127'}),
