...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteSettings.event_web_hook'
        db.alter_column(u'core_sitesettings', 'event_web_hook', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'SiteSettings.event_web_hook'
        db.alter_column(u'core_sitesettings', 'event_web_hook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'core.sitesettings': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event_web_hook': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
