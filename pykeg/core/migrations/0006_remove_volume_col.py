...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Drink.volume'
        db.delete_column('core_drink', 'volume')
        
        # Deleting field 'KegSize.volume'
        db.delete_column('core_kegsize', 'volume')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Drink.volume'
        db.add_column('core_drink', 'volume', orm['core.drink:volume'])
        
        # Adding field 'KegSize.volume'
        db.add_column('core_kegsize', 'volume', orm['core.kegsize:volume'])
