...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_drink', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, on_delete=models.PROTECT, to=orm['core.Keg']))

    def backwards(self, orm):

        # Changing field 'Drink.keg'
        db.alter_column(u'core_drink', 'keg_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Keg'], on_delete=models.PROTECT))
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'0135b303f43080e528fa12bc8bd1997a'", 'unique': 'True', 'max_length': '127'}),
