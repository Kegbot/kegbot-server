...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Picture.drink'
        db.delete_column(u'core_picture', 'drink_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_picture', 'keg',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='deprecated_pictures', null=True, to=orm['core.Keg'], blank=True),
                      keep_default=False)

        # Adding field 'Picture.drink'
        db.add_column(u'core_picture', 'drink',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='deprecated_pictures', null=True, to=orm['core.Drink'], blank=True),
                      keep_default=False)

        # Adding field 'Picture.session'
        db.add_column(u'core_picture', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='deprecated_pictures', null=True, to=orm['core.DrinkingSession'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'585dbf902a5cccefd314cb65700550bf'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
