...
class User(AbstractBaseUser):
    # The reverse names of related fields in PermissionsMixin cause a
    # conflict if we just extend AbstractUser.  Workaround: compose
    # User "by hand", modifying related_name where necessary.
    ...
    groups = models.ManyToManyField('auth.Group', verbose_name=_('groups'),
        blank=True, help_text=_('The groups this user belongs to. A user will '
                                ...
                                'his/her group.'),
        related_name="user_set_2", related_query_name="user")
