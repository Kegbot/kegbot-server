...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_beertype', (
            ...
            ('beerdb_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='beer_types', null=True, to=orm['core.Picture'])),
            ('untappd_beer_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['BeerType'])

        # Adding model 'BeerStyle'
        db.create_table(u'core_beerstyle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('edited', self.gf('django.db.models.fields.DateTimeField')()),
            ('beerdb_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.send_create_signal(u'core', ['BeerStyle'])
        ...
        db.create_table(u'core_brewer', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='beer_brewers', null=True, to=orm['core.Picture'])),
        ))
        db.send_create_signal(u'core', ['Brewer'])

        # Adding field 'Keg.beer_type'
        db.add_column(u'core_keg', 'beer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BeerType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BeerType'
        db.delete_table(u'core_beertype')

        # Deleting model 'BeerStyle'
        db.delete_table(u'core_beerstyle')

        # Deleting model 'Brewer'
        db.delete_table(u'core_brewer')

        # Deleting field 'Keg.beer_type'
        db.delete_column(u'core_keg', 'beer_type_id')
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'a5020da665d88e00f01b438aed2784f0'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
