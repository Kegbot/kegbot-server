...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KegbotSite.epoch'
        db.add_column('core_kegbotsite', 'epoch',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KegbotSite.epoch'
        db.delete_column('core_kegbotsite', 'epoch')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'56d8b942c7c76409273ecbdb23ab9208'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
