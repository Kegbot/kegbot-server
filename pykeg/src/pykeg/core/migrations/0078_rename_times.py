...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('core_keg', 'startdate', 'start_time')
        db.rename_column('core_keg', 'enddate', 'end_time')
        db.rename_column('core_drink', 'starttime', 'time')
        for tbl in ('core_drinkingsession', 'core_kegsessionchunk',
            'core_sessionchunk', 'core_usersessionchunk'):
          db.rename_column(tbl, 'starttime', 'start_time')
          db.rename_column(tbl, 'endtime', 'end_time')
        db.rename_column('core_systemevent', 'when', 'time')
        db.rename_column('core_picture', 'created_date', 'time')
        db.rename_column('core_authenticationtoken', 'created', 'created_time')
        db.rename_column('core_authenticationtoken', 'expires', 'expire_time')
        db.rename_column('core_thermosummarylog', 'date', 'time')
        for tbl in ('core_userstats', 'core_kegstats', 'core_sessionstats',
            'core_systemstats'):
          db.rename_column(tbl, 'date', 'time')

    def backwards(self, orm):
        db.rename_column('core_keg', 'start_time', 'startdate')
        db.rename_column('core_keg', 'end_time', 'enddate')
        db.rename_column('core_drink', 'time', 'starttime')
        for tbl in ('core_drinkingsession', 'core_kegsessionchunk',
            'core_sessionchunk', 'core_usersessionchunk'):
          db.rename_column(tbl, 'start_time', 'starttime')
          db.rename_column(tbl, 'end_time', 'endtime')
        db.rename_column('core_systemevent', 'when', 'time')
        db.rename_column('core_picture', 'created_date', 'time')
        db.rename_column('core_authenticationtoken', 'created', 'created_time')
        db.rename_column('core_authenticationtoken', 'expires', 'expire_time')
        db.rename_column('core_thermosummarylog', 'time', 'date')
        for tbl in ('core_userstats', 'core_kegstats', 'core_sessionstats',
            'core_systemstats'):
          db.rename_column('core_userstats', 'time', 'date')
    ...
    models = {
        ...
        'core.drinkingsession': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': '()', 'null': 'True', 'populate_from': 'None', 'blank': 'True'}),
        ...
        'core.kegsessionchunk': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keg_chunks'", 'to': "orm['core.KegbotSite']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'volume_ml': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        'core.kegsize': {
        ...
        'core.kegtap': {
            ...
            'current_keg': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'current_tap'", 'unique': 'True', 'null': 'True', 'to': "orm['core.Keg']"}),
        ...
        'core.picture': {
            ...
            'seqn': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pictures'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['core.DrinkingSession']"}),
        ...
        'core.sitesettings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_timeout_minutes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '90'}),
            'site': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'settings'", 'unique': 'True', 'to': "orm['core.KegbotSite']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        'core.systemevent': {
            'Meta': {'ordering': "('-time', '-id')", 'object_name': 'SystemEvent'},
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'46864401e719ea64cb468b7967aa929b'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        'core.usersessionchunk': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_chunks'", 'to': "orm['core.KegbotSite']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'core.userstats': {
            ...
            'stats': ('pykeg.core.jsonfield.JSONField', [], {'default': "'{}'"}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'stats'", 'null': 'True', 'to': "orm['auth.User']"})
        }
    }
