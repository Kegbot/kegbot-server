...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KegTap.sort_order'
        db.add_column(u'core_kegtap', 'sort_order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KegTap.sort_order'
        db.delete_column(u'core_kegtap', 'sort_order')
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'750c2dc6d046071af1f50d00e3ca9ee4'", 'unique': 'True', 'max_length': '127'}),
