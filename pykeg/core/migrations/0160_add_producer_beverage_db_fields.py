...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeverageProducer.beverage_backend'
        db.add_column(u'core_beverageproducer', 'beverage_backend',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BeverageProducer.beverage_backend_id'
        db.add_column(u'core_beverageproducer', 'beverage_backend_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeverageProducer.beverage_backend'
        db.delete_column(u'core_beverageproducer', 'beverage_backend')

        # Deleting field 'BeverageProducer.beverage_backend_id'
        db.delete_column(u'core_beverageproducer', 'beverage_backend_id')
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'7956175a96a2eb67311dd7216b3bb7cb'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'b5a07c5f-8daf-4f2b-a28d-60c77cd85824'", 'unique': 'True', 'max_length': '255'}),
