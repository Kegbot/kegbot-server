...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Keg.spilled_ml'
        db.alter_column('core_keg', 'spilled_ml', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Keg.spilled_ml'
        db.alter_column('core_keg', 'spilled_ml', self.gf('django.db.models.fields.FloatField')(null=True))
