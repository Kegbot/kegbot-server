...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSettings.google_analytics_id'
        db.add_column('core_sitesettings', 'google_analytics_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSettings.google_analytics_id'
        db.delete_column('core_sitesettings', 'google_analytics_id')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'b5fd2bb1a014ef41857c8c6cdfc539db'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
