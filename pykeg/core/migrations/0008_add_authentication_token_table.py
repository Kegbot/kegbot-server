...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_authenticationtoken', (
            ('id', orm['core.authenticationtoken:id']),
            ('auth_device', orm['core.authenticationtoken:auth_device']),
            ('token_value', orm['core.authenticationtoken:token_value']),
            ('pin', orm['core.authenticationtoken:pin']),
            ('user', orm['core.authenticationtoken:user']),
            ('created', orm['core.authenticationtoken:created']),
            ('enabled', orm['core.authenticationtoken:enabled']),
            ('expires', orm['core.authenticationtoken:expires']),
        ))
        db.send_create_signal('core', ['AuthenticationToken'])
        
        # Creating unique_together for [auth_device, token_value] on AuthenticationToken.
    ...
    def backwards(self, orm):
        ...
        # Deleting unique_together for [auth_device, token_value] on AuthenticationToken.
