...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'core_keg', 'beer_type_id', 'type_id')

    def backwards(self, orm):
        db.rename_column(u'core_keg', 'type_id', 'beer_type_id')
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'fe3f8141beea22ff2351002d86460822'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
