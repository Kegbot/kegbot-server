...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for keg in orm['core.Keg'].objects.all():
            print 'Updating keg %d volumes ..' % keg.id
            keg.served_volume_ml = 0
            keg.full_volume_ml = keg.size.volume_ml
            for drink in orm['core.Drink'].objects.filter(keg_id=keg.id):
                keg.served_volume_ml += drink.volume_ml
            keg.save()
