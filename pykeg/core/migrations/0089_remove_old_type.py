...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Keg.type'
        db.delete_column(u'core_keg', 'type_id')


        # Changing field 'Keg.beer_type'
        db.alter_column(u'core_keg', 'beer_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.BeerType']))

    def backwards(self, orm):
        # Adding field 'Keg.type'
        db.add_column(u'core_keg', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['beerdb.BeerType']),
                      keep_default=False)


        # Changing field 'Keg.beer_type'
        db.alter_column(u'core_keg', 'beer_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BeerType'], null=True))
    ...
    models = {
        ...
        u'core.keg': {
            ...
            'beer_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.BeerType']"}),
        ...
        u'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'4b216ade90116911a9d8aa2f7db97a05'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
