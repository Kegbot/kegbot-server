...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KegTap.ml_per_tick'
        db.delete_column(u'core_kegtap', 'ml_per_tick')


    def backwards(self, orm):
        # Adding field 'KegTap.ml_per_tick'
        db.add_column(u'core_kegtap', 'ml_per_tick',
                      self.gf('django.db.models.fields.FloatField')(default=0.18518518518518517),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'8521720344758636d0129d0ff947b824'", 'unique': 'True', 'max_length': '127'}),
