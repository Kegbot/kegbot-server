...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_pourpicture', (
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pictures', null=True, to=orm['core.DrinkingSession'], on_delete=models.SET_NULL, blank=True)),
            ...
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pictures', null=True, to=orm['core.Keg'], on_delete=models.SET_NULL, blank=True)),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pictures', null=True, to=orm['core.Drink'], blank=True)),
