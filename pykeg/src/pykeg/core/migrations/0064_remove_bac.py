...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_bac', (
            ...
            ('bac', self.gf('django.db.models.fields.FloatField')()),
        ))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'ee48226fd2b4261c6e448454df2288f2'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
