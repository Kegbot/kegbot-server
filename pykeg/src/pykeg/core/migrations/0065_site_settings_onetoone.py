...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_sitesettings', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['core.KegbotSite']))


    def backwards(self, orm):
        
        # Changing field 'SiteSettings.site'
        db.alter_column('core_sitesettings', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['core.KegbotSite']))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'9d51cac5e96cfb7fdd3be5b92810e33a'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
