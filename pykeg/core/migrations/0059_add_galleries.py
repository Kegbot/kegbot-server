...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_picture', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seqn', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pictures', null=True, to=orm['core.KegbotSite'])),
            ...
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pictures', null=True, to=orm['core.Keg'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pictures', null=True, to=orm['core.DrinkingSession'])),
            ('drink', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Drink'], null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Picture'])

        # Adding field 'KegbotSite.new_background_image'
        db.add_column('core_kegbotsite', 'new_background_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Picture'], null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.new_mugshot'
        db.add_column('core_userprofile', 'new_mugshot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Picture'], null=True, blank=True), keep_default=False)

        if not db.dry_run:
          seqn = 1
          for site in orm.KegbotSite.objects.all():
            if site.background_image:
              old_image = site.background_image
              new_image = orm.Picture.objects.create(site=site,
                  image=old_image, seqn=seqn,
                  caption='Background image for site %s' % site.name)
              new_image.save()
              site.background_name = None
              site.new_background_image = new_image
              site.save()
              seqn += 1
          for profile in orm.UserProfile.objects.all():
            if profile.mugshot:
              old_mugshot = profile.mugshot
              new_mugshot = orm.Picture.objects.create(image=old_mugshot.image,
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_picture')

        # Deleting field 'KegbotSite.new_background_image'
        db.delete_column('core_kegbotsite', 'new_background_image_id')

        # Deleting field 'UserProfile.new_mugshot'
        db.delete_column('core_userprofile', 'new_mugshot_id')
    ...
    models = {
        ...
        'core.kegbotsite': {
            ...
            'new_background_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Picture']", 'null': 'True', 'blank': 'True'}),
        ...
        'core.picture': {
            ...
            'drink': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Drink']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'4d0566c782d1a11c7d71526539ccea8d'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'new_mugshot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Picture']", 'null': 'True', 'blank': 'True'}),
