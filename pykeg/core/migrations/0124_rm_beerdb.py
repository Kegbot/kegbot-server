...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_beertype', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='beer_types', null=True, to=orm['core.Picture'], on_delete=models.SET_NULL, blank=True)),
        ...
        db.create_table(u'core_brewer', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='beer_brewers', null=True, to=orm['core.Picture'], on_delete=models.SET_NULL, blank=True)),
