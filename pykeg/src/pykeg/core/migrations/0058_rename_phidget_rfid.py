...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        if not db.dry_run:
          for row in orm.AuthenticationToken.objects.filter(auth_device='contrib.phidget.rfid'):
            row.auth_device = 'core.rfid'
            row.save()
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'540541f56dddbaeea91583c2ba203b99'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
