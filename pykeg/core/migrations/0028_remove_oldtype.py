...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Keg.oldtype'
        db.delete_column('core_keg', 'oldtype_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Keg.oldtype'
        db.add_column('core_keg', 'oldtype', self.gf('django.db.models.fields.related.ForeignKey')(default='xxx', to=orm['core.BeerType']), keep_default=False)
