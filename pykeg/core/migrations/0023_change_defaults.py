...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Keg.description'
        db.alter_column('core_keg', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True))

        # Changing field 'Keg.origcost'
        db.alter_column('core_keg', 'origcost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Keg.description'
        db.alter_column('core_keg', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Keg.origcost'
        db.alter_column('core_keg', 'origcost', self.gf('django.db.models.fields.FloatField')())
