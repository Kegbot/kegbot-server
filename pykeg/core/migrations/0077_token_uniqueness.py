...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('core_authenticationtoken', ['site_id', 'seqn'])

        # Adding unique constraint on 'AuthenticationToken', fields ['auth_device', 'site', 'token_value']
        db.create_unique('core_authenticationtoken', ['auth_device', 'site_id', 'token_value'])

    def backwards(self, orm):
        # Removing unique constraint on 'AuthenticationToken', fields ['auth_device', 'site', 'token_value']
        db.delete_unique('core_authenticationtoken', ['auth_device', 'site_id', 'token_value'])

        # Removing unique constraint on 'AuthenticationToken', fields ['site', 'seqn']
        db.delete_unique('core_authenticationtoken', ['site_id', 'seqn'])

        # Adding unique constraint on 'AuthenticationToken', fields ['auth_device', 'site', 'token_value', 'seqn']
        db.create_unique('core_authenticationtoken', ['auth_device', 'site_id', 'token_value', 'seqn'])
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'897d8b65dd1f9596460abc906e81613f'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
