...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotificationSettings.user'
        db.alter_column(u'notification_notificationsettings', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

    def backwards(self, orm):

        # Changing field 'NotificationSettings.user'
        db.alter_column(u'notification_notificationsettings', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
