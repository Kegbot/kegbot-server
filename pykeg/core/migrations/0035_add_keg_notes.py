...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Keg.notes'
        db.add_column('core_keg', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Keg.notes'
        db.delete_column('core_keg', 'notes')
    ...
    models = {
        ...
        'core.drink': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.DrinkingSession']", 'null': 'True', 'blank': 'True'}),
