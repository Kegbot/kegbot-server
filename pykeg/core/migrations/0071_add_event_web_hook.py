...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSettings.event_web_hook'
        db.add_column('core_sitesettings', 'event_web_hook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSettings.event_web_hook'
        db.delete_column('core_sitesettings', 'event_web_hook')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'199151de0b01f40432acda1fb9dbd763'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
