...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_kegstats', 'drink',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Drink']),
                      keep_default=False)

        # Adding field 'KegStats.keg'
        db.add_column(u'core_kegstats', 'keg',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='stats', to=orm['core.Keg']),
                      keep_default=False)
        ...
        # Adding field 'UserStats.user'
        db.add_column(u'core_userstats', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='stats', null=True, to=orm['auth.User']),
                      keep_default=False)
        ...
        # Adding field 'SessionStats.session'
        db.add_column(u'core_sessionstats', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='stats', to=orm['core.DrinkingSession']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'KegStats.keg'
        db.delete_column(u'core_kegstats', 'keg_id')

        # Deleting field 'UserStats.drink'
        db.delete_column(u'core_userstats', 'drink_id')

        # Deleting field 'UserStats.user'
        db.delete_column(u'core_userstats', 'user_id')

        # Deleting field 'SessionStats.drink'
        db.delete_column(u'core_sessionstats', 'drink_id')

        # Deleting field 'SessionStats.session'
        db.delete_column(u'core_sessionstats', 'session_id')
