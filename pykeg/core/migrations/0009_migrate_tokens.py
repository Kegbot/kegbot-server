...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for old_token in orm.Token.objects.all():
          new_token = orm.AuthenticationToken(auth_device='core.onewire',
              token_value=old_token.keyinfo,
              user=old_token.user,
    ...
    def backwards(self, orm):
        ...
        for new_token in orm.AuthenticationToken.objects.all():
          old_token = orm.Token(user=new_token.user,
              keyinfo=new_token.token_value,
