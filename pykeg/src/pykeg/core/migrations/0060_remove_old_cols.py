...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_userprofile', 'mugshot_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_userprofile', 'mugshot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserPicture'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'ec2070675594f79f63c93ed36579bdb0'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
