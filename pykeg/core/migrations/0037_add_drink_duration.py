...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drink.duration'
        db.add_column('core_drink', 'duration', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        for d in orm.Drink.objects.all():
            d.duration = (d.endtime - d.starttime).seconds
            d.save()
    
    
    def backwards(self, orm):
        
        # Deleting field 'Drink.duration'
        db.delete_column('core_drink', 'duration')
