...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelayLog.seqn'
        db.add_column('core_relaylog', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'AuthenticationToken.seqn'
        db.add_column('core_authenticationtoken', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'DrinkingSession.seqn'
        db.add_column('core_drinkingsession', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'DrinkingSession.site'
        db.add_column('core_drinkingsession', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sessions', to=orm['core.KegbotSite']), keep_default=False)

        # Adding field 'ThermoSensor.seqn'
        db.add_column('core_thermosensor', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'ThermoSummaryLog.seqn'
        db.add_column('core_thermosummarylog', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Keg.seqn'
        db.add_column('core_keg', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Drink.seqn'
        db.add_column('core_drink', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Thermolog.seqn'
        db.add_column('core_thermolog', 'seqn', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)
    
        # Copy id to seqn field.
        if not db.dry_run:
            TABLES = (
                orm.RelayLog,
                orm.AuthenticationToken,
                orm.DrinkingSession,
                orm.ThermoSensor,
                orm.ThermoSummaryLog,
                orm.Keg,
                orm.Drink,
                orm.Thermolog,
            )
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RelayLog.seqn'
        db.delete_column('core_relaylog', 'seqn')

        # Deleting field 'AuthenticationToken.seqn'
        db.delete_column('core_authenticationtoken', 'seqn')

        # Deleting field 'DrinkingSession.seqn'
        db.delete_column('core_drinkingsession', 'seqn')

        # Deleting field 'DrinkingSession.site'
        db.delete_column('core_drinkingsession', 'site_id')

        # Deleting field 'ThermoSensor.seqn'
        db.delete_column('core_thermosensor', 'seqn')

        # Deleting field 'ThermoSummaryLog.seqn'
        db.delete_column('core_thermosummarylog', 'seqn')

        # Deleting field 'Keg.seqn'
        db.delete_column('core_keg', 'seqn')

        # Deleting field 'Drink.seqn'
        db.delete_column('core_drink', 'seqn')

        # Deleting field 'Thermolog.seqn'
        db.delete_column('core_thermolog', 'seqn')
