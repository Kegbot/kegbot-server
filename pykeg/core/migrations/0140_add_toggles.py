...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for tap in orm['core.KegTap'].objects.all():
            ...
            controller_name = relay_name[:idx]
            port_name = relay_name[idx+1:]

            controller = orm['core.Controller'].objects.get_or_create(name=controller_name)[0]
            toggle = orm['core.FlowToggle'].objects.get_or_create(controller=controller,
                port_name=port_name, defaults={'tap': tap})[0]

            print 'Migrated tap: %s -> %s' % (tap.relay_name, toggle)


    def backwards(self, orm):
        orm['core.FlowToggle'].objects.all().delete()
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ab6402bdbd605f7c37b748e8e1de8c32'", 'unique': 'True', 'max_length': '127'}),
