...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_kegtap', 'current_keg_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['core.Keg'], unique=True))

    def backwards(self, orm):

        # Changing field 'KegTap.current_keg'
        db.alter_column(u'core_kegtap', 'current_keg_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Keg']))
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'0e6bcea3ce7e5ef879a74acb3d941c57'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            'expires_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
            'for_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'71a874cf-b990-4489-97b0-056f2548e83a'", 'unique': 'True', 'max_length': '255'}),
