...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KegTap.relay_name'
        db.delete_column(u'core_kegtap', 'relay_name')


    def backwards(self, orm):
        # Adding field 'KegTap.relay_name'
        db.add_column(u'core_kegtap', 'relay_name',
    ...
    models = {
        ...
        u'core.apikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'169835fd549e74efe65bfd2ba69183ff'", 'unique': 'True', 'max_length': '127'}),
