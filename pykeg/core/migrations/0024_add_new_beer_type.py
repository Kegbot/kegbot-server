...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Keg.newtype'
        db.add_column('core_keg', 'newtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beerdb.BeerType'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Keg.newtype'
        db.delete_column('core_keg', 'newtype_id')
