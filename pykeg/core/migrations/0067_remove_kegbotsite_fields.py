...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_kegbotsite', 'background_image_id')

        # Deleting field 'KegbotSite.description'
        db.delete_column('core_kegbotsite', 'description')
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_kegbotsite', 'background_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Picture'], null=True, blank=True), keep_default=False)

        # Adding field 'KegbotSite.description'
        db.add_column('core_kegbotsite', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
        ...
        if not db.dry_run:
            for site in orm.KegbotSite.objects.all():
                ss = site.settings
                site.title = ss.title
                site.description = ss.description
                site.background_image = ss.background_image
                site.save()
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'a05f5f3878b5dc5b01b782d2502a7b1b'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
