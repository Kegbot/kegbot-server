...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DrinkClassification.minimum_volume'
        db.delete_column('twitter_drinkclassification', 'minimum_volume')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'DrinkClassification.minimum_volume'
        db.add_column('twitter_drinkclassification', 'minimum_volume', orm['twitter.drinkclassification:minimum_volume'])
