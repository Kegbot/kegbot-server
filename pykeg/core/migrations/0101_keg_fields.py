...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Keg.status'
        db.delete_column(u'core_keg', 'status')

        # Deleting field 'Keg.origcost'
        db.delete_column(u'core_keg', 'origcost')

        # Adding field 'Keg.online'
        db.add_column(u'core_keg', 'online',
    ...
    def backwards(self, orm):
        # Adding field 'Keg.status'
        db.add_column(u'core_keg', 'status',
                      self.gf('django.db.models.fields.CharField')(default='offline', max_length=128),
                      keep_default=False)

        # Adding field 'Keg.origcost'
        db.add_column(u'core_keg', 'origcost',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Keg.online'
        db.delete_column(u'core_keg', 'online')
