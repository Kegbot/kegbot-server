...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'core_sitesettings', 'display_units', 'volume_display_units')
        db.add_column(u'core_sitesettings', 'temperature_display_units',
                      self.gf('django.db.models.fields.CharField')(default='f', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        db.rename_column(u'core_sitesettings', 'volume_display_units', 'display_units')
        db.delete_column(u'core_sitesettings', 'temperature_display_units')
