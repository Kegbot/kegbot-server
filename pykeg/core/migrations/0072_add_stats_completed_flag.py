...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionStats.completed'
        db.add_column('core_sessionstats', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'KegStats.completed'
        db.add_column('core_kegstats', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SessionStats.completed'
        db.delete_column('core_sessionstats', 'completed')

        # Deleting field 'KegStats.completed'
        db.delete_column('core_kegstats', 'completed')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'d673c5d47509e34fade4cd9f7d6365b2'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
