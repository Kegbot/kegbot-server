...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Drink.shout'
        db.add_column('core_drink', 'shout', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Drink.shout'
        db.delete_column('core_drink', 'shout')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'20bb0bce8ac932e01fa03ecffdc8aafe'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
