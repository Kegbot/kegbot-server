...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserPicture.for_user'
        db.add_column('core_userpicture', 'for_user', orm['core.userpicture:for_user'])
        for pic in orm.UserPicture.objects.all():
          pic.for_user = pic.user
          pic.save()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserPicture.for_user'
        db.delete_column('core_userpicture', 'for_user_id')
    ...
    models = {
        ...
        'core.userpicture': {
            ...
            'for_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'userpicture2'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
