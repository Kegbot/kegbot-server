...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Keg.spilled_ml'
        db.add_column('core_keg', 'spilled_ml', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Keg.spilled_ml'
        db.delete_column('core_keg', 'spilled_ml')
