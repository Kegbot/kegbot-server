...
<div class="content">
   {if $usehistory}
   <p>
      full drink history for keg shown below. <a href="/keg-info.php?keg={$keg->id}">hide history</a>.
   <p>
   ...
   {else}
   <p>
      to show full drink history for this keg, <a href="?keg={ $keg->id }&history=1">click here</a>
   </p>
   {/if}
</div>
