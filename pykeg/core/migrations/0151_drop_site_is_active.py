...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_kegbotsite', 'is_active')


    def backwards(self, orm):
        # Adding field 'KegbotSite.is_active'
        db.add_column(u'core_kegbotsite', 'is_active',
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'ea4ea01cf78ce9371275c28653ae4064'", 'unique': 'True', 'max_length': '127'}),
