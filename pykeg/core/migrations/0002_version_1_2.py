    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=True, help_text=b"Enable and show features related to volume sensing."
            ),
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                help_text=b"User-visible description of the Keg.", null=True, blank=True
            ),
            preserve_default=True,
        ),
        ...
        migrations.AlterField(
            ...
            name="notes",
            field=models.TextField(
                help_text=b"Private notes about this tap.", null=True, blank=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                max_length=32,
                choices=[
                    (b"corny-2_5-gal", b"Corny Key (2.5 gal)"),
                    (b"other", b"Other"),
                    ...
                    (b"corny-3-gal", b"Corny Keg (3.0 gal)"),
                    (b"euro-30-liter", b"European DIN (30 L)"),
