...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_invitation', (
            ...
            ('invite_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ...
            ('expires_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 21, 0, 0))),
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'KegbotSite.registration_mode'
        db.delete_column(u'core_kegbotsite', 'registration_mode')
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'d7abeb6d4a71f44c7797cc876cb17304'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            'expires_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            'for_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
        ...
        u'core.kegbotsite': {
            ...
            'epoch': ('django.db.models.fields.PositiveIntegerField', [], {'default': '108'}),
