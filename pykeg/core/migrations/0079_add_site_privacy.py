...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.privacy'
        db.add_column('core_sitesettings', 'privacy',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length='63'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.privacy'
        db.delete_column('core_sitesettings', 'privacy')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'857ff296b213f961bf37036affcc3a51'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
