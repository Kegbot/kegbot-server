...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_kegbotsite', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'KegbotSite.background_image'
        db.add_column('core_kegbotsite', 'background_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KegbotSite.title'
        db.delete_column('core_kegbotsite', 'title')

        # Deleting field 'KegbotSite.background_image'
        db.delete_column('core_kegbotsite', 'background_image')
    ...
    models = {
        ...
        'beerdb.beertype': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'beers'", 'blank': 'True', 'null': 'True', 'to': "orm['beerdb.BeerImage']"}),
        ...
        'beerdb.brewer': {
            ...
            'edited': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'brewers'", 'blank': 'True', 'null': 'True', 'to': "orm['beerdb.BeerImage']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'core.drink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'drinks'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Keg']"}),
            'seqn': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'drinks'", 'blank': 'True', 'null': 'True', 'to': "orm['core.DrinkingSession']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'drinks'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'core.kegsessionchunk': {
            ...
            'endtime': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keg_session_chunks'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Keg']"}),
        ...
        'core.sessionchunk': {
            ...
            'endtime': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session_chunks'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Keg']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chunks'", 'to': "orm['core.DrinkingSession']"}),
            'starttime': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session_chunks'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'volume_ml': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        'core.sessionstats': {
        ...
        'core.systemevent': {
            ...
            'drink': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Drink']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Keg']"}),
            'kind': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'seqn': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'blank': 'True', 'null': 'True', 'to': "orm['core.DrinkingSession']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': "orm['core.KegbotSite']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'core.usersessionchunk': {
            ...
            'starttime': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_session_chunks'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'volume_ml': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        'core.userstats': {
