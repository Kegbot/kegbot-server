...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.timezone'
        db.add_column(u'core_sitesettings', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='UTC', max_length=255),
                      keep_default=False)
        if not db.dry_run:
            for site in orm['core.SiteSettings'].objects.all():
                site.timezone = settings.TIME_ZONE
                site.save()


    def backwards(self, orm):
        # Deleting field 'SiteSettings.timezone'
        db.delete_column(u'core_sitesettings', 'timezone')
