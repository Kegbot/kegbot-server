...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_kegbotsite', 'guest_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='guest_images', null=True, to=orm['core.Picture'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'4e936ef7f3d0d1173bb08065274615d4'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'6bc5f590-2bcb-458a-b16d-000b7b6c0b62'", 'unique': 'True', 'max_length': '255'}),
