...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('core_userstats', ['user_id'])

        # Changing field 'UserStats.user'
        db.alter_column('core_userstats', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Adding unique constraint on 'UserStats', fields ['site', 'user']
        db.create_unique('core_userstats', ['site_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserStats', fields ['site', 'user']
        db.delete_unique('core_userstats', ['site_id', 'user_id'])

        # Changing field 'UserStats.user'
        orm.UserStats.objects.all().delete()
        db.alter_column('core_userstats', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, unique=True, to=orm['auth.User']))

        # Adding unique constraint on 'UserStats', fields ['user']
        db.create_unique('core_userstats', ['user_id'])
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'8067bc2d21049f1d2b67f3a91ea2e822'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
