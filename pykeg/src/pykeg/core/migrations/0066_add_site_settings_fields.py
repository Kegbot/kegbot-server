...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSettings.title'
        db.add_column('core_sitesettings', 'title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'SiteSettings.description'
        db.add_column('core_sitesettings', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'SiteSettings.background_image'
        db.add_column('core_sitesettings', 'background_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Picture'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SiteSettings.title'
        db.delete_column('core_sitesettings', 'title')

        # Deleting field 'SiteSettings.description'
        db.delete_column('core_sitesettings', 'description')

        # Deleting field 'SiteSettings.background_image'
        db.delete_column('core_sitesettings', 'background_image_id')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'73bb6c2fb59087209c357b4fad38f9c1'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
