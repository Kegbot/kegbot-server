...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_apikey', (
            ...
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=127)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'core', ['ApiKey'])

        # Deleting field 'UserProfile.api_secret'
        db.delete_column(u'core_userprofile', 'api_secret')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_userprofile', 'api_secret',
                      self.gf('django.db.models.fields.CharField')(default='40045060b6939f9ffa3e365292e4d1f0', max_length=256, null=True, blank=True),
                      keep_default=False)
