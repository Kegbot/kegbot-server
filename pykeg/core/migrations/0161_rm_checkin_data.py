...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KegbotSite.last_checkin_time'
        db.delete_column(u'core_kegbotsite', 'last_checkin_time')

        # Deleting field 'KegbotSite.last_checkin_response'
        db.delete_column(u'core_kegbotsite', 'last_checkin_response')


    def backwards(self, orm):
        # Adding field 'KegbotSite.last_checkin_time'
        db.add_column(u'core_kegbotsite', 'last_checkin_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'KegbotSite.last_checkin_response'
        db.add_column(u'core_kegbotsite', 'last_checkin_response',
                      self.gf('pykeg.core.jsonfield.JSONField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'core.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'3cd90b44187bcefe22f15706d6735a93'", 'unique': 'True', 'max_length': '127'}),
        ...
        u'core.invitation': {
            ...
            'expires_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 31, 0, 0)'}),
            'for_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'default': "'4169747b-e390-472b-ba4a-e21b43f0e9d8'", 'unique': 'True', 'max_length': '255'}),
