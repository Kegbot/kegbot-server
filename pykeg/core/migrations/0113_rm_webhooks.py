...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_sitesettings', 'description')

        # Deleting field 'SiteSettings.web_hook_urls'
        db.delete_column(u'core_sitesettings', 'web_hook_urls')


    def backwards(self, orm):
        # Adding field 'SiteSettings.description'
        db.add_column(u'core_sitesettings', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SiteSettings.web_hook_urls'
        db.add_column(u'core_sitesettings', 'web_hook_urls',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
