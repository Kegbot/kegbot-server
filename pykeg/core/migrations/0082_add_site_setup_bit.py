...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KegbotSite.is_setup'
        db.add_column('core_kegbotsite', 'is_setup',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KegbotSite.is_setup'
        db.delete_column('core_kegbotsite', 'is_setup')
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'090bccce8e01792e648c85c86bf55272'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
